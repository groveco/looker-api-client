...
class AuthApi(object):
    ...
    def create_oidc_test_config(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_oidc_test_config(body, callback=callback_function)
        ...
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_oidc_test_config`")

        resource_path = '/oidc_test_configs'.replace('{format}', 'json')
        path_params = {}
    ...
    def delete_oidc_test_config(self, test_slug, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_oidc_test_config(test_slug, callback=callback_function)
        ...
        if ('test_slug' not in params) or (params['test_slug'] is None):
            raise ValueError("Missing the required parameter `test_slug` when calling `delete_oidc_test_config`")

        resource_path = '/oidc_test_configs/{test_slug}'.replace('{format}', 'json')
        path_params = {}
    ...
    def oidc_config(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.oidc_config(callback=callback_function)
        ...
        resource_path = '/oidc_config'.replace('{format}', 'json')
        path_params = {}
    ...
    def oidc_test_config(self, test_slug, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.oidc_test_config(test_slug, callback=callback_function)
        ...
        # verify the required parameter 'test_slug' is set
        if ('test_slug' not in params) or (params['test_slug'] is None):
            raise ValueError("Missing the required parameter `test_slug` when calling `oidc_test_config`")
    ...
    def update_oidc_config(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_oidc_config(body, callback=callback_function)
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_oidc_config`")
