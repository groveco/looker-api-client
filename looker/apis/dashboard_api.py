...
class DashboardApi(object):
    ...
    def create_dashboard_prefetch(self, dashboard_id, **kwargs):
        ...
        ### Create a prefetch for a dashboard with the specified information.\n\n**Deprecated**\nUse [DataGroups](#!/Datagroup) to manage cache invalidation of groups of queries.\n
    ...
    def import_lookml_dashboard(self, lookml_dashboard_id, space_id, **kwargs):
        ...
        all_params = ['lookml_dashboard_id', 'space_id', 'body']
        all_params.append('callback')
    ...
    def search_dashboards(self, **kwargs):
        ...
        all_params = ['fields', 'id', 'slug', 'page', 'per_page', 'limit', 'offset', 'sorts', 'title', 'description', 'content_favorite_id', 'space_id', 'deleted', 'user_id', 'view_count']
        all_params.append('callback')
    ...
    def sync_lookml_dashboard(self, lookml_dashboard_id, body, **kwargs):
        ...
        all_params = ['lookml_dashboard_id', 'body']
        all_params.append('callback')
